...
.bg {
  /* The image used */
  background-image: url("https://www.pixelstalk.net/wp-content/uploads/2016/08/1280-x-1024-Desktop-Wallpaper.jpg");
...
<body class="bg" style="margin-top: 110px">
	<center>
		<h1 style="color: white">Sign In - Al Quran API</h1>
